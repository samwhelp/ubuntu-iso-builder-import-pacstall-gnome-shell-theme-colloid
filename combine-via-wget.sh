...
REF_WORK_DIR_PATH="${HOME}/work/ubuntu-iso-builder-import-pacstall-gnome-shell-theme-colloid"
...
echo "[Next Step]: cd ~/work/ubuntu-iso-builder-import-pacstall-gnome-shell-theme-colloid/iso-profile
"
echo
